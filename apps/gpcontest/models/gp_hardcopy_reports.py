...
class BoundaryStudentScoreGroups(models.Model):
    ...
    questiongroup_name = models.CharField(
        max_length=150, db_column="questiongroup_name")
    questiongroup_id = models.CharField(
        max_length=150, db_column="questiongroup_id")
...
class BoundaryCountsAgg(models.Model):
    ...
    num_districts = models.IntegerField(db_column="num_districts")
...
class GPInstitutionClassQDetailsAgg(models.Model):
    ...
    question_id = models.ForeignKey(
        'assessments.Question', db_column="question_id", 
        on_delete=models.DO_NOTHING)
    question_sequence = models.IntegerField(db_column="question_sequence")
    question_local_lang_text = models.CharField(
        db_column="question_lang_name", max_length=200)
...
class GPContestSchoolDetails(models.Model):
    ...
    gp_id = models.ForeignKey(
        'boundary.ElectionBoundary', db_column="gp_id", 
        on_delete=models.DO_NOTHING)
...
class SurveyInstitutionHHRespondentTypeAnsAgg(models.Model):
    ...
    survey_id = models.ForeignKey(
        'assessments.Survey', db_column="survey_id", 
        on_delete=models.DO_NOTHING)
    institution_id = models.ForeignKey(
        'schools.Institution', db_column="institution_id", 
        on_delete=models.DO_NOTHING)
    questiongroup_id = models.ForeignKey(
        'assessments.QuestionGroup', db_column="questiongroup_id", 
        on_delete=models.DO_NOTHING)
...
class HHSurveyInstitutionQuestionAnsAgg(models.Model):
    ...
    institution_name = models.CharField(
        max_length=200, db_column="institution_name")
    gp_id = models.ForeignKey(
        'boundary.ElectionBoundary', db_column="gp_id", 
        on_delete=models.DO_NOTHING)
    ...
    question_id = models.ForeignKey(
        ...
        on_delete=models.DO_NOTHING)
    question_desc = models.CharField(max_length=200, db_column="question_desc")
    lang_questiondesc = models.CharField(
        max_length=200, db_column="lang_questiondesc")
    total = models.IntegerField(db_column="total")

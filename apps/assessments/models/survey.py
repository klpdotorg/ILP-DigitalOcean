...
class QuestionGroup(models.Model):
    ...
    status = models.ForeignKey(
                                'common.Status',
                                on_delete=models.DO_NOTHING)
    image_required = models.BooleanField(default=False,null=True)
    comments_required = models.BooleanField(default=False,null=True)
    respondenttype_required = models.BooleanField(default=False)

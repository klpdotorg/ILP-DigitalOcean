...
(function() {
            ...
            var division_id = $("#select-division").val(),
                ...
                if(institution_id) {
                    ...
                    if(cluster_id) {
                        ...
                        url += '&boundary_id=' + taluk_id;
                    }else if(district_id) {
                        url += '&boundary_id=' + district_id;
                    } else if(division_id) {
                        url += '&boundary_id=' + division_id;
                    }
                }
    ...
    function loadGPContestData(params){
        ...
        var $summaryXHR = klp.api.do("survey/summary/?survey_id=" + gpContestId, params);
        $summaryXHR.done(function(summaryData) {
        ...
        var $questionGroupXHR = klp.api.do("survey/detail/questiongroup/key/?survey_id=" + gpContestId, params);
